...
class Modal extends BaseComponent {
  ...
  createModalContainerIsNotExist(t) {
    ...
    }, 500)), this.overlay = document.createElement("div"), this.overlay.classList.add("sq-fixed"), this.overlay.classList.add("sq-inset-0"), this.overlay.classList.add("sq-bg-[#00000080]"), this.overlay.classList.add("sq-z-[99999]"), this.overlay.addEventListener("click", () => {
   ...
   */
  async render(t) {
    this.createModalContainerIsNotExist(t), this._create(this.wrapper, t), document.body.appendChild(this.overlay), t.template === "modal_post" && this.wrapperOverlay ? this.overlay.appendChild(this.wrapperOverlay) : this.wrapperOverlay && this.overlay.removeChild(this.wrapperOverlay), this.overlay.appendChild(this.wrapper), document.body.style.overflow = "hidden", console.log(t), setTimeout(() => {
...
class Squarelovin {
  ...
  async _initializeContainer(e) {
    ...
    await this.getCookieToken(o), console.log("2023-11-13 10:23"), !(!i || !o || !a || !n) && (s !== ON_LOAD_ATTR_TYPES.getValue("loader") && this._renderComponent(c), s === ON_LOAD_ATTR_TYPES.getValue("no") && _isElementInViewport(
      t,
      () => {
        let u = {};
        n === "product-details" && (u = {
