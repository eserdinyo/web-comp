...
class Modal extends BaseComponent {
  ...
  createModalContainerIsNotExist(t) {
    ...
    }, 200)), this.overlay = document.createElement("div"), this.overlay.classList.add("sq-fixed"), this.overlay.classList.add("sq-inset-0"), this.overlay.classList.add("sq-bg-[#00000080]"), this.overlay.classList.add("sq-z-[99999]"), document.addEventListener("click", (s) => {
      var i = document.getElementById("sq-popup-main-full-content");
      i.contains(s.target) || (window.history.replaceState(null, "", window.location.href.split("#")[0]), this.destroy());
    }));
  }
  /*
   ...
   */
  async render(t) {
    this.createModalContainerIsNotExist(t), this._create(this.wrapper, t), document.body.appendChild(this.overlay), (t.template === "modal_post" || t.template === "report") && this.wrapperOverlay ? this.overlay.appendChild(this.wrapperOverlay) : this.wrapperOverlay && this.overlay.removeChild(this.wrapperOverlay), this.overlay.appendChild(this.wrapper), document.body.style.overflow = "hidden";
  }
  /*
